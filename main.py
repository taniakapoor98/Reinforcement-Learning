...
# # # };
#
# player2Controls = game.getPlayer2Controls()  # Retrieve the control array once
# #
# player2KeyMap = {
#     'left': player2Controls[2],  # Left action
#     'right': player2Controls[3],  # Right action
#     # 'up': player2Controls[0],  # Up action
#     'down': player2Controls[1],  # Down action
#     'light_attack': player2Controls[4],  # Light attack
#     'medium_attack': player2Controls[5],  # Medium attack
#     'heavy_attack': player2Controls[6],  # Heavy attack
# }
#
#
# #
# def player2_action(action):
#     time.sleep(0.5)
#     game.player2Move(player2KeyMap[action])  # light attack
#     time.sleep(0.5)
...
# # #
# player2_action('up')
# player2_action('right')
# player2_action('left')
# player2_action('light_attack')
# player2_action('heavy_attack')
# player2_action('medium_attack')
# # print(player2Controls)
# for x in player2Controls:
#     print(x)
